...
class Job(models.Model):
    ...
    company_number = models.IntegerField(null=False,blank=False)# 사업자 등록번호
    ...
    company_size = models.IntegerField(null=True, blank=True)# 직원수
    company_homepage = models.CharField(max_length = 50, null=True, blank=True)# 홈페이지
    company_logo = models.ImageField(null=True, blank=True)# 회사로고
    ...
    apply_num = models.IntegerField(null = False, blank = False)# 모집인원
    ...
    apply_age = models.IntegerField(null = False, blank= False)# 연령
